...
class Article(models.Model):
    ...
    main_page = models.BooleanField(
        "Головна", default=True, help_text="Показувати на головній сторінці"
    )
...
class ArticleImage(models.Model):
    article = models.ForeignKey(
        Article, verbose_name="Стаття", related_name="images", on_delete=models.CASCADE
    )
    image = models.ImageField("Фото", upload_to="photos")
    title = models.CharField(
        "Заголовок", max_length=250, help_text="Максимум 250 сим.", blank=True
    )
